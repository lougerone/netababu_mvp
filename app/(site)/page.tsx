  ...
  <div className="absolute inset-0 z-0 flex items-center justify-center overflow-hidden">
    ...
    <div className="relative h-[90%] w-[90%]">
      <Image
        ...
        style={{
          // Clean left/right fade using mask-image
          WebkitMaskImage:
    ...
    {/* Single clean vignette overlay - fades to background color */}
    <div
      className="pointer-events-none absolute inset-0 z-10"
      style={{
        background:
          'radial-gradient(ellipse 140% 100% at 50% 50%, transparent 45%, rgba(255,247,237,0.6) 75%, #fff7ed 100%)',
      }}
    />

    {/* Subtle top/bottom fades for polish */}
    <div className="pointer-events-none absolute inset-0 z-10">
      <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-cream-200/80 to-transparent" />
      <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-cream-200/80 to-transparent" />
    </div>
  </div>
