    ...
    <footer role="contentinfo" className="mt-12 md:mt-16 border-t border-black/10">
      <div className="mx-auto max-w-6xl px-4 pt-10 pb-8 grid gap-8 md:grid-cols-4">
        <div>
          ...
          <p className="mt-2 text-sm text-ink-600/80">
            Public, neutral, and source-driven political data. Not affiliated with any party,
      ...
      <div className="mx-auto max-w-6xl px-4 pb-4 text-xs text-ink-600/80">
        <p className="leading-relaxed">
          <strong>Disclaimer:</strong> While we strive to ensure accuracy and completeness,
          Netababu provides all information on an <em>“as is”</em> and <em>“as available”</em> basis
          for general information and public-interest purposes only. We make no representations or
          warranties of any kind—express or implied—about the accuracy, completeness, reliability,
          suitability, or timeliness of any content. Your use of the site and reliance on any
          information is at your own risk. To the fullest extent permitted by law, Netababu disclaims
          all liability for errors, omissions, or any loss or damage arising from or in connection
          with the use of the site or its content. Party names, symbols, and person names are used
          for identification only; no endorsement is implied.
        </p>
      </div>
