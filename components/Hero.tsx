  ...
  return (
    <section className="relative">
      <div className="relative isolate">
        <Image
          src="/hero/hero-2560w.webp" // use the largest
      ...
      <div className="absolute inset-0 flex items-end">
        <div className="mx-auto w-full max-w-6xl px-4 pb-8 md:pb-10 lg:pb-12">
          ...
          <p className="mt-3 max-w-2xl text-sm text-white/85 md:text-base">
            Netababu brings together politicians, parties, timelines, and credible references—so you can explore facts without the noise.
          </p>
          <div className="mt-5 flex flex-wrap gap-3">
            <Link href="/politicians" className="rounded-2xl bg-white px-4 py-2 text-sm font-medium text-ink-900 shadow hover:bg-white/90">Explore Politicians</Link>
            <Link href="/parties" className="rounded-2xl border border-white/70 bg-white/10 px-4 py-2 text-sm font-medium text-white backdrop-blur hover:bg-white/15">Browse Parties</Link>
            <Link href="/compare" className="rounded-2xl border border-white/20 px-4 py-2 text-sm font-medium text-white/90 hover:border-white/40">Compare (X vs Y)</Link>
          </div>
        </div>
      </div>
    </section>
